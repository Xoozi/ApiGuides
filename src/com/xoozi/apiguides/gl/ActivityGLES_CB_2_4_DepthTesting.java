...
public class ActivityGLES_CB_2_4_DepthTesting extends Activity implements
    ...
    public class MyRenderer implements Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            _dice1.bindData(_colorShaderProgram);
            _dice1.draw();

            _positionObjectInScene(_pos2.x, _pos2.y, _pos2.z);
            _colorShaderProgram.useProgram();
            _colorShaderProgram.setUniforms(_MVPMatrix);
            _dice2.bindData(_colorShaderProgram);
            _dice2.draw();
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            _colorShaderProgram = new CB_2_ShaderProgram(
                    ActivityGLES_CB_2_4_DepthTesting.this);

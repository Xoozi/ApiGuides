...
import com.xoozi.apiguides.gl.programs.CB_5_PerV_Ambient_ShaderProgram;
...
public class ActivityGLES_CB_5_1_PerVertex_Ambient extends Activity implements
        SensorEventListener, OnTouchListener {
    private Sensor _rotationVectorSensor;
    private SensorManager _sensorManager;

    private GLSurfaceView _glSurfaceView;
    private CB_5_PerV_Ambient_ShaderProgram _ambientShaderProgram;
    ...
    private DiceVBO _dice1;
    private DiceVBO _dice2;

    private int _width;
    private int _height;

    private Vector _pos1 = new Vector(-4, 1, 1);
    private Vector _pos2 = new Vector(-3, 1, 1);
    ...
    public class MyRenderer implements Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            _ambientShaderProgram.setMaterial(0, 1, 0);
            _ambientShaderProgram.setLight(1, 1, 1);

            _positionObjectInScene(_pos1.x, _pos1.y, _pos1.z);
            _ambientShaderProgram.useProgram();
            _ambientShaderProgram.setMatrix(_MVPMatrix);
            _dice1.bindData(_ambientShaderProgram);
            _dice1.draw();

            _ambientShaderProgram.setMaterial(1, 1, 1);
            _ambientShaderProgram.setLight(0.34f, 0.21f, 0.105f);

            _positionObjectInScene(_pos2.x, _pos2.y, _pos2.z);
            _ambientShaderProgram.useProgram();
            _ambientShaderProgram.setMatrix(_MVPMatrix);
            _dice2.bindData(_ambientShaderProgram);
            _dice2.draw();
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            _ambientShaderProgram = new CB_5_PerV_Ambient_ShaderProgram(
                    ActivityGLES_CB_5_1_PerVertex_Ambient.this);

            setIdentityM(_rotationMatrix, 0);
            _dice1 = new DiceVBO(0.5f);
            _dice2 = new DiceVBO(0.2f);
        }
    }
